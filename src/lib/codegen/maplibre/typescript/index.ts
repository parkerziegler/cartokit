...
import { codegenImports } from '$lib/codegen/maplibre/typescript/codegen-imports';
import type { CartoKitIR } from '$lib/types';

/**
 * Generate a MapLibre GL JS program, in TypeScript, from the CartoKit IR.
 *
 * @param ir – The CartoKit IR.
 * @returns – A MapLibre GL JS program, in TypeScript.
 */
