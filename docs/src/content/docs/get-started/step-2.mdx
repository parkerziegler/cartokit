...
<p class="text-xl text-gray-700 tracking-wide dark:text-gray-200">`cartokit` supports styling geospatial data using a wide range of cartographic forms, including choropleth, proportional symbol, dot density, and more.</p>
