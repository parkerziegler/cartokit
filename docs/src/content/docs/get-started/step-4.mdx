...
<p class="text-xl text-gray-700 tracking-wide dark:text-gray-200">`cartokit` compiles your map into a Mapbox GL JS program in real-time, making it easy to transfer the code to your development environment.</p>
...
4. Replace `"<YOUR_MAPBOX_ACCESS_TOKEN>"` in the program with your own [Mapbox access token](https://docs.mapbox.com/help/getting-started/access-tokens/).
    ...
    <Code code={mapboxAccessTokenDiff} lang="javascript" title="src/main.js" useDiffSyntax />
